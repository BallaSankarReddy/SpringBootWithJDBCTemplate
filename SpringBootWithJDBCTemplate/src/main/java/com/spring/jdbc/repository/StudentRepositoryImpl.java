...
public class StudentRepositoryImpl extends BaseRepository<Student> implements StudentRepository{
	...
	private final String SELECT_STUDENT_BY_NAME ="SELECT * FROM student_Data  where name =:name";
	...
	public Student getStudentName(String name) {
		...
		Student queryForObject = getNamedParameterJdbcTemplate().queryForObject(SELECT_STUDENT_BY_NAME, parameterSource, BeanPropertyRowMapper.newInstance(Student.class));
